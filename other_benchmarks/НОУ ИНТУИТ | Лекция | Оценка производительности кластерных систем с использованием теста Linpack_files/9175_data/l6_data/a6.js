...
var R=[
  ...
  [{
    ...
    idS: '143',
    s: function(cb){
	(function(h){function k(){var a=function(d,b){if(this instanceof AdriverCounter)d=a.items.length||1,a.items[d]=this,b.ph=d,b.custom&&(b.custom=a.toQueryString(b.custom,";")),a.request(a.toQueryString(b));
	else return a.items[d]};a.httplize=function(a){return(/^\/\//.test(a)?location.protocol:"")+a};a.loadScript=function(a){try{var b=g.getElementsByTagName("head")[0],c=g.createElement("script");
	c.setAttribute("type","text/javascript");c.setAttribute("charset","windows-1251");c.setAttribute("src",a.split("![rnd]").join(Math.round(1E6*Math.random())));
	c.onreadystatechange=function(){/loaded|complete/.test(this.readyState)&&(c.onload=null,b.removeChild(c))};c.onload=function(){b.removeChild(c)};b.insertBefore(c,b.firstChild)}catch(f){}};a.toQueryString=function(a,b,c){b=b||"&";
	c=c||"=";var f=[],e;for(e in a)a.hasOwnProperty(e)&&f.push(e+c+escape(a[e]));return f.join(b)};a.request=function(d){var b=a.toQueryString(a.defaults);a.loadScript(a.redirectHost+"/cgi-bin/erle.cgi?"+d+"&rnd=![rnd]"+(b?"&"+b:""))};
	a.items=[];a.defaults={tail256:document.referrer||"unknown"};a.redirectHost="https://ad.adriver.ru";return a}var g=document;"undefined"===typeof AdriverCounter&&(AdriverCounter=k());new AdriverCounter(0,h)})
	({sid:1, bt:62, ad:659456});
	}
  },{
    id: 2,
    idS: '19',
  ...
  [{
    ...
    id: 42,
    idS: '53821_1',
    c: (document.cookie.indexOf('ar_53821krasota2') == -1) && cid && cookiestate == 0,
    s: function(cb){
      (function(L){if(typeof(ar_cn)=="undefined")ar_cn=1;
        ...
        _();ar_cn++;
      })('//ad.adriver.ru/cgi-bin/erle.cgi?sid=1&ad=660736&bt=43&bn=660736&tail256=');
      cb();
    },
    t: 24
  },{
    id: 43,
    idS: '53821_2',
    c:(document.cookie.indexOf('ar_53821_monitori2') == -1) && cid && cookiestate == 0,
    s: function(cb){
      (function(L){if(typeof(ar_cn)=="undefined")ar_cn=1;
        var S='setTimeout(function(e){if(!self.CgiHref){document.close();e=parent.document.getElementById("ar_container_"+ar_bnum);e.parentNode.removeChild(e);}},3000);',
          j=' type="text/javascript"',t=0,D=document,n=ar_cn;L='' + ('https:' == document.location.protocol ? 'https:' : 'http:') + ''+L+escape(D.referrer||'unknown')+'&rnd='+Math.round(Math.random()*999999999);
        function _(){if(t++<100){var F=D.getElementById('ar_container_'+n);
          ...
          D.body.appendChild(_c);
        _();ar_cn++;
      })('//ad.adriver.ru/cgi-bin/erle.cgi?sid=1&ad=660733&bt=43&bn=660733&tail256=');
      cb();
    },
    t: 24
  },{
    id: 44,
    idS: '53821_3',
    c:(document.cookie.indexOf('ar_53821studenti2') == -1) && cid && cookiestate == 0,
    s: function(cb){
      (function(L){if(typeof(ar_cn)=="undefined")ar_cn=1;
        var S='setTimeout(function(e){if(!self.CgiHref){document.close();e=parent.document.getElementById("ar_container_"+ar_bnum);e.parentNode.removeChild(e);}},3000);',
          j=' type="text/javascript"',t=0,D=document,n=ar_cn;L='' + ('https:' == document.location.protocol ? 'https:' : 'http:') + ''+L+escape(D.referrer||'unknown')+'&rnd='+Math.round(Math.random()*999999999);
        function _(){if(t++<100){var F=D.getElementById('ar_container_'+n);
          ...
          D.body.appendChild(_c);
        _();ar_cn++;
      })('//ad.adriver.ru/cgi-bin/erle.cgi?sid=1&ad=660735&bt=43&bn=660735&tail256=');
      cb();
    },
    t: 24
  },{
    id: 45,
    idS: '53821_4',
    c: (document.cookie.indexOf('ar_53821zrenie2') == -1) && cid && cookiestate == 0,
    s: function(cb){
      (function(L){if(typeof(ar_cn)=="undefined")ar_cn=1;
        var S='setTimeout(function(e){if(!self.CgiHref){document.close();e=parent.document.getElementById("ar_container_"+ar_bnum);e.parentNode.removeChild(e);}},3000);',
          j=' type="text/javascript"',t=0,D=document,n=ar_cn;L='' + ('https:' == document.location.protocol ? 'https:' : 'http:') + ''+L+escape(D.referrer||'unknown')+'&rnd='+Math.round(Math.random()*999999999);
        function _(){if(t++<100){var F=D.getElementById('ar_container_'+n);
          ...
          D.body.appendChild(_c);
        _();ar_cn++;
      })('//ad.adriver.ru/cgi-bin/erle.cgi?sid=1&ad=660589&bt=43&bn=660589&tail256=');
      cb();
    },
    t: 24
  },{
